...
class Google {
	...
	*/
	...
	public static function register_settings( $settings ){
		...
		Google\Analytics::register_settings(self::$options);
		Google\Youtube::register_settings(self::$options);
	 ...
	 * @return none
	 */
	public static function init_service( $services ){
		foreach( $services as $service_name ){
			...
			if( $service_name == 'analytics' ){
				...
				Google\Analytics::create_service();

			}  else if( $service_name == 'youtube' ){
