...
class Youtube {
	 ...
	 */
	public static function list_video( $video_id, $parts = array(), $return_type = 'object' ){
		if( empty($parts) ){
		...
		if( $return_type == 'object' )
			return $result;
		else if( $return_type == 'simple_object' )
	 ...
	 * @return none
	 */
	public static function save_youtube_meta($post_id, $meta_fields = array('_youtube'), $parts = array() ){
	...
	public static function video_in_content($content){
