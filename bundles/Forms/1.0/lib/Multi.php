...
class Multi {
	...
	public static function default_data($fields)
	{
	...
	public static function load($value, $fields)
	{
		...
		self::$data = self::default_data($fields);
	...
	public static function add_values($basename, $args, $value)
	{
	...
	public static function handle_type_url($data_array)
	{
	...
	public static function form($args, $value)
	{
		...
		$wrapper_classes = array('sb-multi-wrapper', $name.'-wrapper', $class);
	...
	public static function fields($basename, $fields, $remove, $value)
	{
		...
		foreach ($fields as $name => $args) {
			...
			// handle value
			if (!empty($value)) {
				$args = self::add_values($name, $args, $value);
			}
