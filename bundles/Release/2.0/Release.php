...
class Release
{
    ...
    public static function registerSettings()
    {
        ...
        add_filter('pre_update_option_sb-release-passwd', 'SB\Forms\Common::encryptPassword');
    ...
    public static function stylesheet()
    {
        ...
        wp_register_style('sb-release', Utils::getBundleUri('Release').'/css/admin.css');
    ...
    public static function getAllThemes()
    {
        ...
        foreach ($custom_dirs as $custom_dir) {
            if (file_exists($custom_dir.'/lib/')) {
                $dir = dir($custom_dir.'/lib/');
                while (false !== ($theme = $dir->read())) {
                    if ($theme == '.' || $theme == '..') {
                        continue;
                    }
                    if ($theme == 'Release') {
                        $current_theme = wp_get_theme(basename($custom_dir), $theme_root);
    ...
    public static function validatePassword()
    {
        ...
        $password = Common::decryptPassword($encrypted_password);
    ...
    public static function printReleasePage($settings)
    {
        ...
        if (false !== strpos($settings['theme'], '/bundles/Release/')) {
            $theme_path = Utils::getBundleUri('Release').'/themes/'.basename($settings['theme']);
        } elseif (is_child_theme()) {

            if (get_stylesheet_directory().'/lib/Release' == $settings['theme']) {
                $theme_path = get_stylesheet_directory_uri().'/lib/Release';
            } else {
